...
type UnwarnCommandProps = {
  isDark: boolean;
};

const UnwarnCommand = ({ isDark }: UnwarnCommandProps) => {
    ...
    <div className={`font-[Outfit] px-6 py-12 min-h-screen transition ${bgColor} mr-[17%] ml-[17%]`}>
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold">Command: unwarn</h1>
        ...
        <div className="mb-4">
          ...
          <p className="text-sm opacity-80">user: Mention the user whose warning you want to remove (Required).</p>
          <p className="text-sm opacity-80">warning-id: Specify the ID of the warning to remove (Optional). Defaults to the most recent warning if not specified.</p>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li><code>/unwarn user:@Username</code> – Remove the most recent warning for a user</li>
            <li><code>/unwarn user:@Username warning-id:1234</code> – Remove a specific warning by ID</li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>The unwarn command helps in managing and rectifying moderation actions when necessary.</li>
          </ul>
        </div>
