...
type UnbanCommandProps = {
  isDark: boolean;
};

const UnbanCommand = ({ isDark }: UnbanCommandProps) => {
    ...
    <div className={`font-[Outfit] px-6 py-12 min-h-screen transition ${bgColor} mr-[17%] ml-[17%]`}>
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold">Command: unban</h1>
        ...
        <div className="mb-4">
          ...
          <p className="text-sm opacity-80">user: The user to unban (Required)</p>
        </div>

        <div className="mb-4">
          <h3 className="font-semibold mb-1">Required Permissions</h3>
          <p className="text-sm opacity-80">BanMembers</p>
        </div>

        <div className="mb-4">
          <h3 className="font-semibold mb-1">Usage Examples</h3>
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li><code>/unban userID</code> – Unban the user with the specified ID</li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>This command allows you to unban a user previously banned from the server. It requires the "Ban Members" permission to execute.</li>
          </ul>
        </div>
