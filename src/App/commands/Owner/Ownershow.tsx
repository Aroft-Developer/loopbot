...
type OwnerShowCommandProps = {
  isDark: boolean;
};

const OwnerShowCommand = ({ isDark }: OwnerShowCommandProps) => {
    ...
    <div className={`font-[Outfit] px-6 py-12 min-h-screen transition ${bgColor} mr-[17%] ml-[17%]`}>
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        <div className="flex items-center justify-between mb-4">
          <h1 className="text-2xl font-bold">Command: owner-show</h1>
          <span className={`text-xs font-semibold px-2 py-1 rounded ${badgeColor}`}>owner</span>
        </div>

        <h2 className="text-xl font-semibold mb-2">Description</h2>
        <p className="text-sm opacity-80 mb-4">
          Display a list of members who are owners of the bot.
        </p>

        <div className="mb-4">
          <h3 className="font-semibold mb-1">Subcommands</h3>
          <p className="text-sm opacity-80">/owner-show – Show the list of bot owners.</p>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li><code>/owner-show</code> – Show the list of bot owners</li>
          </ul>
        </div>
        ...
        <div className="mb-4">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>This command provides a list of users who have owner privileges, granting them special access to the bot.</li>
            <li>Ensure you have the necessary permissions to use this command.</li>
            <li>The list is updated automatically when users are added or removed from the owner list.</li>
          </ul>
        </div>
...
export default OwnerShowCommand;
