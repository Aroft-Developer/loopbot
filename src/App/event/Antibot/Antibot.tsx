...
type AntibotEventProps = {
  isDark: boolean;
};

const Antibot = ({ isDark }: AntibotEventProps) => {
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        ...
        <div className="mb-4">
          ...
          <p className="text-sm opacity-80">
            This identifier is used for events triggered by the antibot system when it detects suspicious bot activities.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>Automatic expulsion of detected bot accounts</li>
            <li>Notification in a moderation channel</li>
            <li>Recording of the incident for future security measures</li>
          </ul>
        </div>
