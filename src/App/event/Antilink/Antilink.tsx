...
type AntilinkEventProps = {
  isDark: boolean;
};

const Antilink = ({ isDark }: AntilinkEventProps) => {
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        ...
        <div className="mb-4">
          ...
          <p className="text-sm opacity-80">
            This identifier is used for events triggered by the antilink system when it detects unauthorized links in messages.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>Automatic removal of messages containing links</li>
