...
type AntinewaccountEventProps = {
  isDark: boolean;
};

const Antinewaccount = ({ isDark }: AntinewaccountEventProps) => {
      ...
      <div className={`rounded-xl p-6 shadow border ${borderColor} ${cardColor}`}>
        ...
        <div className="mb-4">
          ...
          <p className="text-sm opacity-80">
            This identifier is used for events triggered by the antinewaccount system when it detects recently created accounts joining the server.
          </p>
        </div>
        ...
        <div className="mb-6">
          ...
          <ul className="list-disc list-inside text-sm opacity-80 space-y-1">
            <li>Automatic verification or restriction of recent accounts</li>
            <li>Notification in a moderation channel</li>
            <li>Recording details for security measures</li>
          </ul>
        </div>
